...
async def compatibility_routes() -> dict[str, object]:
    ...
    return {
        ...
        "targets": [
            ...
            {"legacy": "/api/admin/emotions/realtime-stats", "owner": "app.api.admin.dashboard", "status": "migrated"},
            {"legacy": "/health/all", "owner": "src.main", "status": "migrated"},
            {"legacy": "/config", "owner": "src.main", "status": "migrated"},
        ],
    }
